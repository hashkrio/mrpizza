...
@extends('layouts.app')
@section('title', __('Addon Management') . ' - ' . company_name())
                ...
                <div class="card">
                            ...
                            <div class="btn-group flex-wrap mb-0">
                                <div class="ms-1">
                                    <a href="{{ route('admin.addons.create') }}"
                                        class="btn btn-primary">{{ __('Add Addon') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table border="1" class="table datatable" id="addon_table">
                                <thead>
                                    <tr>
                                        <th>{{ __('Sr No.') }}</th>
                                        <th>{{ __('Name') }}</th>
...
@push('js_script')
    <script type="text/javascript">
        $(function() {
            var table = $('#addon_table').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                ...
                                Swal.fire({
                                    ...
                                    text: @json(__('Addon has been deleted.')),
                                    icon: "success",
                                    timer: 2000,
