...
<head>
    ...
    <title>{{ __('Forgot Password') }} - {{ company_name() }}</title>
        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-none d-xl-flex col-xl-8 p-0">
                <div class="auth-cover-bg d-flex justify-content-center align-items-center">
                    <img src="{{ login_cover() ?? asset('/assets/img/login_cover.png') }}" alt="auth-forgot-cover"
                        class="my-5 auth-illustration" />
                    <img src="{{ asset('assets/img/illustrations/bg-shape-image-light.png') }}" alt="auth-forgot-cover"
                        class="platform-bg" />
                </div>
            </div>
