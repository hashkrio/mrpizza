                    ...
                    <tr>
                        <td class="content-body" style="padding: 40px 35px; color: #333333;">
                            ...
                            <h3 class="greeting-text" style="margin-top: 0; color: #111111; font-size: 20px;">
                                {{ __('Welcome') }}, {{ $name ?? __('Valued Customer') }}! 👋
                            </h3>

                            <p class="body-text" style="font-size: 15px; color: #555555; line-height: 1.6;">
                                {{ __('Thank you for registering with us. To complete your account creation and verify your email address, please use the One-Time Password (OTP) code below') }}:
                            </p>
                            ...
                            <p class="expiry-text" style="font-size: 14px; color: #444444;">
                                ⏳ {{ __('This verification code is valid for 10 minutes') }}.
                            </p>

                            <p class="warning-text" style="font-size: 14px; color: #777777;">
                                {{ __('If you did not initiate this registration, please ignore this email or contact support if you have concerns.') }}
                            </p>
